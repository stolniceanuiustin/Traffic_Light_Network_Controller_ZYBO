# 0 "D:\\ProiectSSC\\.rigel_lopper_temp_platform\\design_1_wrapper\\hw\\sdt\\system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "D:\\ProiectSSC\\.rigel_lopper_temp_platform\\design_1_wrapper\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "D:\\ProiectSSC\\.rigel_lopper_temp_platform\\design_1_wrapper\\hw\\sdt\\zynq-7000.dtsi" 1
# 10 "D:\\ProiectSSC\\.rigel_lopper_temp_platform\\design_1_wrapper\\hw\\sdt\\zynq-7000.dtsi"
/ {
 #address-cells = <1>;
 #size-cells = <1>;
...
# 3 "D:\\ProiectSSC\\.rigel_lopper_temp_platform\\design_1_wrapper\\hw\\sdt\\system-top.dts" 2
# 1 "D:\\ProiectSSC\\.rigel_lopper_temp_platform\\design_1_wrapper\\hw\\sdt\\pl.dtsi" 1
/ {
 amba_pl: amba_pl {
  ranges;
  compatible = "simple-bus";
  ...
  axi_gpio_rx_data: gpio@41200000 {
   ...
   clock-names = "s_axi_aclk";
   xlnx,tri-default = <0xffffffff>;
   xlnx,name = "axi_gpio_rx_data";
   xlnx,all-inputs = <1>;
  };
  axi_gpio_rx_ready: gpio@41210000 {
   xlnx,gpio-board-interface = "Custom";
   compatible = "xlnx,axi-gpio-2.0" , "xlnx,xps-gpio-1.00.a";
   xlnx,all-outputs = <0>;
   #gpio-cells = <2>;
   ...
   clock-names = "s_axi_aclk";
   xlnx,tri-default = <0xffffffff>;
   xlnx,name = "axi_gpio_rx_ready";
   xlnx,all-inputs = <1>;
  };
  axi_gpio_sws: gpio@41270000 {
  ...
  axi_gpio_tx_data: gpio@41220000 {
   xlnx,gpio-board-interface = "Custom";
   compatible = "xlnx,axi-gpio-2.0" , "xlnx,xps-gpio-1.00.a";
   xlnx,all-outputs = <1>;
   #gpio-cells = <2>;
   ...
   clock-names = "s_axi_aclk";
   xlnx,tri-default = <0xffffffff>;
   xlnx,name = "axi_gpio_tx_data";
   xlnx,all-inputs = <0>;
  };
  axi_gpio_tx_rdy: gpio@41230000 {
   xlnx,gpio-board-interface = "Custom";
   compatible = "xlnx,axi-gpio-2.0" , "xlnx,xps-gpio-1.00.a";
   xlnx,all-outputs = <0>;
   #gpio-cells = <2>;
   ...
   clock-names = "s_axi_aclk";
   xlnx,tri-default = <0xffffffff>;
   xlnx,name = "axi_gpio_tx_rdy";
   xlnx,all-inputs = <1>;
  };
  axi_gpio_tx_start: gpio@41240000 {
   xlnx,gpio-board-interface = "Custom";
   compatible = "xlnx,axi-gpio-2.0" , "xlnx,xps-gpio-1.00.a";
   xlnx,all-outputs = <1>;
   #gpio-cells = <2>;
...
# 4 "D:\\ProiectSSC\\.rigel_lopper_temp_platform\\design_1_wrapper\\hw\\sdt\\system-top.dts" 2
# 1 "D:\\ProiectSSC\\.rigel_lopper_temp_platform\\design_1_wrapper\\hw\\sdt\\pcw.dtsi" 1
 &ps7_cortexa9_0 {
  xlnx,rable = <0>;
 ...
 &ttc0 {
  xlnx,rable = <0>;
  xlnx,ttc-clk2-freq-hz = <108333336>;
  xlnx,ttc-clk1-clksrc = <0>;
  status = "okay";
  xlnx,clock-freq = <108333336>;
  xlnx,ttc-clk2-clksrc = <0>;
  xlnx,ip-name = "ps7_ttc";
  xlnx,ttc-clk0-freq-hz = <108333336>;
  xlnx,ttc-clk1-freq-hz = <108333336>;
...
# 5 "D:\\ProiectSSC\\.rigel_lopper_temp_platform\\design_1_wrapper\\hw\\sdt\\system-top.dts" 2
/ {
 board = "zybo";
 ...
 cpus_a9: cpus-a9@0 {
  ...
  address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
         ...
         <0x41200000 &axi_gpio_rx_data 0x41200000 0x10000>,
         <0x41210000 &axi_gpio_rx_ready 0x41210000 0x10000>,
         <0x41220000 &axi_gpio_tx_data 0x41220000 0x10000>,
         <0x41230000 &axi_gpio_tx_rdy 0x41230000 0x10000>,
         <0x41240000 &axi_gpio_tx_start 0x41240000 0x10000>,
         <0x41250000 &axi_gpio_btns 0x41250000 0x10000>,
         <0x41260000 &axi_gpio_leds 0x41260000 0x10000>,
         <0x41270000 &axi_gpio_sws 0x41270000 0x10000>,
